...
class UsuarioControllerTest {
    ...
    void obtenerUsuario() throws Exception {
        ...
        when(usuarioService.obtenerUsuario((int) 1L)).thenReturn(usuario);
    ...
    void actualizarUsuario() throws Exception {
        ...
        when(usuarioService.actualizarUsuario((int) eq(1L), any(Usuario.class))).thenReturn(usuario);
